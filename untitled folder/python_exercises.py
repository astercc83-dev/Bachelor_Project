...
num_ao_channels = 2
digital_io_channel = 1
print(f"Total AO: {num_ao_channels}")
print(f"Numbers of Input/Output: {digital_io_channel}")
...
# Write your code below:
sampling_rates = [10e2, 10e3, 10e4, 10e5, 14e6]
print(f"The first Sample is: {sampling_rates[0]} S/s")
print(f"The second Sample is: {sampling_rates[1]/1e3} KS/s")
print(f"The third Sample is: {sampling_rates[2]/1e4} KS/s")
print(f"The fourth Sample is: {sampling_rates[3]/1e5} KS/s")
print(f"The fifth Sample is: {sampling_rates[4]/1e6} MS/s")
